...

        {
            ...
            pathname === '/profile' && (
                <div className="mt-5 flex-end gap-4 border-t border-gray-100 pt-3">
                    <p
                      className="font-inter text-sm text-[#fff]   bg-[#228b22] px-4 py-1 rounded-full cursor-pointer"
                      onClick={handleEdit}  
                    >
                        Edit
                    </p>
                    <p
                      className="font-inter text-sm text-white  bg-red-500 px-2 py-1 rounded-full cursor-pointer"
